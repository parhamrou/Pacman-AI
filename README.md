...
2. **MultiAgent Project (Adversarial search)**
   ...
   - Alpha-beta pruning
   - Expectimax
3. **Markov Decision Processes & Reinforcement Learning**
   - Value Iteration
   - Policy Iteration
...
4. **Bayes Nets and Sampling**
   - Implemented Bayesian networks to model probabilistic relationships between variables
   - Used sampling algorithms such as rejection sampling, likelihood weighting, and Gibbs sampling to perform inference on the networks
